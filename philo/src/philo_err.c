...
/*                                                   +#+                      */
/*   Created: 2023/08/24 18:14:24 by yzaim         #+#    #+#                 */
/*   Updated: 2023/08/24 18:51:24 by yzaim         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_other_errors(int error_type)
{
	...
	{
		ft_putstr_fd("Minimum number of philosopher \
		is 1 and maximum number is 200\n", 2);
		return (N_PHILO_ERR);
	}
	return (SUCCESS);
}
...
int	ft_error(int error_type)
{
	...
	else if (error_type == THR_ERR)
	{
		...
		return (ft_other_errors(error_type));
	return (SUCCESS);
}
